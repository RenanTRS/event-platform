...
export type GetLessonBySlugQueryQueryVariables = Exact<{
  slug?: InputMaybe<Scalars['String']>;
}>;


export type GetLessonBySlugQueryQuery = { __typename?: 'Query', lesson?: { __typename?: 'Lesson', videoId: string, title: string, description?: string | null, teacher?: { __typename?: 'Teacher', bio: string, avatarURL: string, name: string } | null } | null };
...
export const GetLessonBySlugQueryDocument = gql`
...
/**
 * __useGetLessonBySlugQueryQuery__
 *
 * To run a query within a React component, call `useGetLessonBySlugQueryQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetLessonBySlugQueryQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetLessonBySlugQueryQuery({
 *   variables: {
 *      slug: // value for 'slug'
 *   },
 * });
 */
export function useGetLessonBySlugQueryQuery(baseOptions?: Apollo.QueryHookOptions<GetLessonBySlugQueryQuery, GetLessonBySlugQueryQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetLessonBySlugQueryQuery, GetLessonBySlugQueryQueryVariables>(GetLessonBySlugQueryDocument, options);
      }
export function useGetLessonBySlugQueryLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetLessonBySlugQueryQuery, GetLessonBySlugQueryQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetLessonBySlugQueryQuery, GetLessonBySlugQueryQueryVariables>(GetLessonBySlugQueryDocument, options);
        }
export type GetLessonBySlugQueryQueryHookResult = ReturnType<typeof useGetLessonBySlugQueryQuery>;
export type GetLessonBySlugQueryLazyQueryHookResult = ReturnType<typeof useGetLessonBySlugQueryLazyQuery>;
export type GetLessonBySlugQueryQueryResult = Apollo.QueryResult<GetLessonBySlugQueryQuery, GetLessonBySlugQueryQueryVariables>;
